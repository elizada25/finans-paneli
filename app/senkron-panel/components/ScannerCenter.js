...
const styles = {
  section: {
    ...
    padding: '18px',
    borderRadius: '18px',
    background: 'linear-gradient(145deg, rgba(83,70,115,0.97), rgba(53,76,106,0.97))',
  ...
  quickButton: {
    ...
    background: 'rgba(190,174,230,0.12)',
    color: '#e2e8f0',
    fontSize: '12px',
    fontWeight: 700,
    cursor: 'pointer',
  ...
  summaryCard: {
    padding: '12px',
    borderRadius: '11px',
    background: 'rgba(177,161,219,0.13)',
