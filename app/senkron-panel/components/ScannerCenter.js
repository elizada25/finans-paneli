...
const QUICK_COMMANDS = [
  {
    ...
    command:
      'BIST 100 hisselerinden günlük bazda EMA 5 EMA 22 yi yukarı kesenleri bul',
  },
  {
    label: 'EMA 5 / EMA 22 aşağı kesişim',
    command:
      'BIST 100 hisselerinden günlük bazda EMA 5 EMA 22 yi aşağı kesenleri bul',
  },
  {
    label: 'EMA 50 / EMA 200 Golden Cross',
    command:
      'BIST 100 hisselerinden günlük bazda EMA 50 EMA 200 ü yukarı kesenleri bul',
  },
  {
    label: 'EMA 50 / EMA 200 Death Cross',
    command:
      'BIST 100 hisselerinden günlük bazda EMA 50 EMA 200 ü aşağı kesenleri bul',
  },
];
...
const styles = {
  section: {
    ...
    borderRadius: '18px',
    background:
      'linear-gradient(145deg, rgba(13,20,31,0.97), rgba(20,29,43,0.97))',
    border:
